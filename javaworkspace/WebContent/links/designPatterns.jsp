	...
	<ul>
		<li>
			<p>I just thought of writing this tutorial about Design patterns
				since I didn't find a good website with a simple real time example.
				I found some, but they explained the logic using Swings which I'm
				not used to. I tried my best to make sure that the examples are
				simple and clear.</p>
		</li>
	</ul>
