...
<ol type="a">
	<li>Permission is granted to temporarily download one copy of the
		materials (information or software) on Javaworkspace's web site for
		...
		<ol type="i">
			...
			<li>attempt to decompile or reverse engineer any software
				contained on Javaworkspace's web site;</li>
	...
	<li>This license shall automatically terminate if you violate any
		of these restrictions and may be terminated by Javaworkspace at any
...
<ol type="a">
	<li>The materials on Javaworkspace's web site are provided "as
		is". Javaworkspace makes no warranties, expressed or implied, and
		hereby disclaims and negates all other warranties, including without
		limitation, implied warranties or conditions of merchantability,
		fitness for a particular purpose, or non-infringement of intellectual
		property or other violation of rights. Further, Javaworkspace does not
...
<p>In no event shall Javaworkspace or its suppliers be liable for
	any damages (including, without limitation, damages for loss of data or
	profit, or due to business interruption,) arising out of the use or
	inability to use the materials on Javaworkspace's Internet site, even
	if Javaworkspace or a Javaworkspace authorized representative has been
...
<p>The materials appearing on Javaworkspace's web site could include
	technical, typographical, or photographic errors. Javaworkspace does
	not warrant that any of the materials on its web site are accurate,
	complete, or current. Javaworkspace may make changes to the materials
	contained on its web site at any time without notice. Javaworkspace
...
<p>Javaworkspace has not reviewed all of the sites linked to its
	...
	Javaworkspace of the site. Use of any such linked web site is at the
	user's own risk.</p>
...
<p>Javaworkspace may revise these terms of use for its web site at
...
<p>Any claim relating to Javaworkspace's web site shall be governed
	by the laws of the State of Karnataka without regard to its conflict of
	law provisions.</p>
